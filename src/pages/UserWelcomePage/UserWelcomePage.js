...
import searchImage from '../../images/search_figure.png';
import demoImage from '../../images/demo_transparent.png';
...
function UserWelcomePage() {
  ...
  const SearchFigure = () => {
    return (
      <div classeName={classes.searchFigure}>
        <h3 className={classes.searchHeader}>Search Products</h3>
        <img className={classes.searchImg} src={searchImage} alt='App Screenshot'></img>
      </div>
    )
  }
    ...
    <div>
      ...
      <div classeName={classes.searchContainer}>
        ...
        <div className={classes.searchExample}>
          ...
          <svg className={classes.curveDivBottom} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1440 320'><path fill='#42b029' fill-opacity='1' d='M0,128L80,149.3C160,171,320,213,480,240C640,267,800,277,960,266.7C1120,256,1280,224,1360,208L1440,192L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z'></path></svg>
        </div>
      </div>
    </div>
  );
